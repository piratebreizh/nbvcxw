...
Route::group(['middleware' => ['web']], function () {
	...
	// User
	Route::get('user/sort/{roles}', 'UserController@indexSort');
	...
	// Staff
	Route::get('staff/sort/{job}', 'StaffControler@indexSort');
	Route::get('staff/roles', 'StaffControler@getRoles');
	Route::post('staff/roles', 'StaffControler@postRoles');
	Route::resource('staff', 'StaffControler');
