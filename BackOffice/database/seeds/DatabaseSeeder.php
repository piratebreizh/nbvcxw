...
use App\Models\Role, App\Models\User, App\Models\Contact, App\Models\Post, App\Models\Tag, App\Models\PostTag, App\Models\Comment, App\Models\Staff;
...
class DatabaseSeeder extends Seeder {
	...
	public function run()
	{
		...
		Staff::create([
			'id_users' => 1,
			'staff_last_name' => 'nom du staff 1232',
			'staff_first_name' => 'Prénom du staff',
			'staff_first_email' => 'adresse mail du test',
			'contract_number' => 'numéro du contract 98769'
		]);

		Staff::create([
			'id_users' => 2,
			'staff_last_name' => 'Dupont',
			'staff_first_name' => 'George',
			'staff_first_email' => 'George@de.Fr',
			'contract_number' => '123 George contract '
		]);
