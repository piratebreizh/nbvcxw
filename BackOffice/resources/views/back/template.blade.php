   ...
   <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <ul class="nav navbar-right top-nav">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="fa fa-user"></span> {{ session('username') }}<b class="caret"></b></a>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    @if(session('statut') == 'admin')
                        ...
                        <li {!! classActiveSegment(2, 'staff') !!}>
                            <a href="#" data-toggle="collapse" data-target="#staffmenu"><span class="fa fa-fw fa-user"></span> {{ trans('back/admin.staff') }} <span class="fa fa-fw fa-caret-down"></span></a>
                            <ul id="staffmenu" class="collapse">
                                <li><a href="{!! url('staff') !!}">{{ trans('back/admin.see-all') }}</a></li>
                                <li><a href="{!! url('staff/create') !!}">Ajouter</a></li>
                            </ul>
                        </li>
                        <li {!! classActiveSegment(3, 'employeur') !!}>
                            <a href="#" data-toggle="collapse" data-target="#employermenu"><span class="fa fa-fw fa-user"></span> {{ trans('back/admin.employer') }} <span class="fa fa-fw fa-caret-down"></span></a>
                            <ul id="employermenu" class="collapse">
                                <li><a href="{!! url('user') !!}">{{ trans('back/admin.see-all') }}</a></li>
                                <li><a href="{!! url('user/create') !!}">{{ trans('back/admin.add') }}</a></li>
                            </ul>
                        </li>
